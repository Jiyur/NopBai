        ...
        <div class="card-header bg-white">
            <div class="media flex-sm-row flex-column-reverse justify-content-between ">
                <div class="col my-auto">
                    <h4 class="mb-0">Cảm ơn đã lựa chọn dịch vụ của chúng tôi,<span
                            class="change-color"> ${user.name}</span> !</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <div class="sq align-self-center "><img
                                            ...
                                            src="${item.food.galleries[0].img_url}" width="135" height="135"/></div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col mt-auto">
                                        <div class="progress">
                                            <div class="progress-bar progress-bar rounded" style="width: 18%"
                                        ...
                                        <div class="media row justify-content-between ">
                                            ...
                                            <div class="flex-col"><span> <small class="text-right mr-sm-2">Out for delivery</small><i
        ...
        <div class="jumbotron-fluid">
            <div class="row justify-content-between ">
                <div class="col-sm-auto col-auto my-auto">
                    <a onclick="window.history.back()" style="text-decoration: none;margin-left: 10px">< Return</a>
                </div>
                <div class="col-auto my-auto ">
                ...
                <div class="col-auto my-auto ml-auto">
                    <h1 class="display-3 "
                        style="color: black;opacity: 0.5 ;transform: scale(0.7)">${order.total}VND</h1>
                </div>
            </div>
